...
import vn.app.qrcode.data.model.MediaItemData.Companion.PLAYBACK_RES_CHANGED
import vn.app.qrcode.databinding.ItemNewsCategoryBinding
...
class CategoryAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MediaViewHolder {
        ...
        val binding = ItemNewsCategoryBinding.inflate(inflater, parent, false)
